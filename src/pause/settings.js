...
export class PceSettingsEditor extends Component {
  constructor() {
    super();
    this.state = {
      tabIndex: null,
...
class PceDisplaySettingsTab extends FieldsTab {
  constructor() {
    super();
...
PceDisplaySettingsTab.contextType = WebrcadeContext;
