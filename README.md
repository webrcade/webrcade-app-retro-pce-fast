# webЯcade Applications: NEC PC Engine, NEC PC Engine CD Emulators

[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)

This repository contains [webЯcade](https://www.webrcade.com) applications for the following NEC systems:

* [NEC PC Engine](#nec-pc-engine-application)
* [NEC PC Engine CD](#nec-pc-engine-cd-application)
...
The license presented above is limited to the [webЯcade](https://www.webrcade.com) application. The underlying Libretro Mednafen PC Engine Fast project retains its own specific licensing.
